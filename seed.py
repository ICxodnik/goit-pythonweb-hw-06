    ...
    async with sessionmanager.session() as session:
        ...
        for _ in range(NUM_STUDENTS):
            student = Student(
                ...
                phone=fake.phone_number() if randint(0, 1) else None,  # 50% chance to have phone
                birthday=fake.date_of_birth(minimum_age=16, maximum_age=25) if randint(0, 1) else None,  # 50% chance to have birthday
